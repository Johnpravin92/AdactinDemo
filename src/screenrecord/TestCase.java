...
{
		ScreenRecorderUtil.startRecord("verify");
		
		driver.findElement(By.xpath("//a[@class='login']")).click();
		driver.findElement(By.xpath("(//input[@type='text'])[2]")).sendKeys("Johnpravin01@gmail.com");
	...
	driver.findElement(By.id("email")).sendKeys("Johnpravin01@gmail.com");
	driver.findElement(By.id("passwd")).sendKeys("John@1234");
